...
export function AuthModal({ isOpen, onClose, defaultView = 'signin' }: AuthModalProps) {
    ...
    const handleGoogleSignIn = async () => {
        ...
        // On success, Supabase redirects — no need to setIsGoogleLoading(false)
    };
                                    ...
                                    {view !== 'reset' && (
                                        <>
                                            <button
                                                ...
                                                className="w-full flex items-center justify-center gap-3 py-3 border border-brand-dark/15 rounded-full font-medium text-brand-dark hover:bg-brand-dark/5 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                                            >
                                                {isGoogleLoading ? (
                                            ...
                                            <div className="flex items-center gap-3 my-5">
                                                ...
                                                <span className="text-xs text-brand-dark/40 font-medium">or</span>
                                                <div className="flex-1 h-px bg-brand-dark/10" />
                                            </div>
                                        </>
                                    )}
